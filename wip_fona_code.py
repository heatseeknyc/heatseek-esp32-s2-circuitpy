...
# SKIFF NOTE: stopped here as I started to fall asleep. 
# Now that we're getting time and setting the RTC correctly, the next step is to 
# ensure that we're building on top of the newest code.py from the main branch (with flashing lights)
# and then refactor it to skip all the networking stuff and send SMS instead
# then I'll need an SMS receiver 
