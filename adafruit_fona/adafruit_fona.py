...
class FONA:
    ...
    def _init_fona(self) -> bool:
        ...
        elif self._buf.find(b"SARA-R410M-02B") != -1:
            self._fona_type = SARA_R410M
    ...
    def get_timestamp(self) -> int:
        ...
        c_month = int(c_date.split('/')[1])
        c_day = int(c_date.split('/')[2])
        c_hour = int(c_time.split(':')[0])
